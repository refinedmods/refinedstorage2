...
public class AutocraftingNetworkComponentImpl implements AutocraftingNetworkComponent, ParentContainer {
    ...
    private final Map<ExternalPatternSinkId, PatternProvider> providerById = new HashMap<>();
    ...
    public void onContainerAdded(final NetworkNodeContainer container) {
        if (container.getNode() instanceof PatternProvider provider) {
            ...
            final ExternalPatternSinkId id = CoreValidations.validateNotNull(provider.getId(),
                "Sink ID can not be null");
    ...
    @Override
    @Nullable
    public PatternProvider getProviderById(final ExternalPatternSinkId id) {
