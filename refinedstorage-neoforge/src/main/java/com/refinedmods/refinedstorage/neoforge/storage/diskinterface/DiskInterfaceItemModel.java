...
import static com.refinedmods.refinedstorage.neoforge.storage.diskinterface.DiskInterfaceRenderingProperties.DISKS;

public class DiskInterfaceItemModel implements ItemModel {
    ...
    public DiskInterfaceItemModel(final List<BakedQuad> baseQuads,
    ...
    private static ItemTransform getDiskTransform(final ItemTransform baseTransform,
        ...
        final Vector3f translation = offsetTransform
            .transformDirection(new Vector3f(DiskInterfaceRenderingProperties.TRANSLATIONS[idx]), new Vector3f())
    ...
    public static class Unbaked implements ItemModel.Unbaked {
        ...
        public ItemModel bake(final BakingContext bakingContext, final Matrix4fc matrix4fc) {
            ...
            final ResolvedModel baseModel = baker.getModel(DiskInterfaceRenderingProperties.getActiveBaseModel(color));
            ...
            final List<BakedQuad> ledQuads = baker.getModel(DiskInterfaceRenderingProperties.INACTIVE_LED_MODEL)
                .bakeTopGeometry(baseModel.getTopTextureSlots(), baker, BlockModelRotation.IDENTITY).getAll();
