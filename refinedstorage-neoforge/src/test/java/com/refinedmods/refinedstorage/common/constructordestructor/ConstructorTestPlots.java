...
final class ConstructorTestPlots {
    ...
    static void preparePlot(final GameTestHelper helper,
        ...
        helper.setBlock(constructorPos, MOD_BLOCKS.getConstructor().getDefault().rotated(direction));
        consumer.accept(
            helper.getBlockEntity(constructorPos, AbstractConstructorBlockEntity.class),
            constructorPos,
