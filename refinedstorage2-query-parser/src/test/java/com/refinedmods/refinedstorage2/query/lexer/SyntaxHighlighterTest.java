...
class SyntaxHighlighterTest {
    ...
    void testSyntaxHighlighting(final String text, final List<SyntaxHighlightedCharacter> expectedItems) {
        // Arrange
        final SyntaxHighlighter syntaxHighlighter = new SyntaxHighlighter(SyntaxHighlighterColors.DEFAULT_COLORS);

        final Lexer lexer = new Lexer(new Source("test", text), LexerTokenMappings.DEFAULT_MAPPINGS);
        lexer.scan();
