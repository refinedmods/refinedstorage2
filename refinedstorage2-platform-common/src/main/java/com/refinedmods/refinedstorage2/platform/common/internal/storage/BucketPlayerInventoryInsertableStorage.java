...
public class BucketPlayerInventoryInsertableStorage implements InsertableStorage<FluidResource> {
    ...
    public long insert(final FluidResource resource, final long amount, final Action action, final Actor actor) {
        ...
        return Platform.INSTANCE.convertToBucket(resource).map(
