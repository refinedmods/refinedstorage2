...
final class DirectionalCableBlockShapes {
    ...
    static final VoxelShape CONSTRUCTOR_DESTRUCTOR_NORTH = Shapes.or(box(2, 2, 0, 14, 14, 2), HOLDER_NORTH);
    static final VoxelShape CONSTRUCTOR_DESTRUCTOR_EAST = Shapes.or(box(14, 2, 2, 16, 14, 14), HOLDER_EAST);
    static final VoxelShape CONSTRUCTOR_DESTRUCTOR_SOUTH = Shapes.or(box(2, 2, 14, 14, 14, 16), HOLDER_SOUTH);
    static final VoxelShape CONSTRUCTOR_DESTRUCTOR_WEST = Shapes.or(box(0, 2, 2, 2, 14, 14), HOLDER_WEST);
    static final VoxelShape CONSTRUCTOR_DESTRUCTOR_DOWN = Shapes.or(box(2, 0, 2, 14, 2, 14), HOLDER_DOWN);
    static final VoxelShape CONSTRUCTOR_DESTRUCTOR_UP = Shapes.or(box(2, 14, 2, 14, 16, 14), HOLDER_UP);
