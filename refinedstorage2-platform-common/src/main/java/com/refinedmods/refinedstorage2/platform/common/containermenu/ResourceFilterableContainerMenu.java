...
public abstract class ResourceFilterableContainerMenu extends BaseContainerMenu implements ResourceTypeAccessor {
    ...
    protected ResourceFilterableContainerMenu(MenuType<?> type, int syncId, OrderedRegistry<ResourceLocation, ResourceType> resourceTypeRegistry, Player player, ResourceFilterContainer container) {
        super(type, syncId);
    ...
    protected ResourceFilterableContainerMenu(MenuType<?> type, int syncId, OrderedRegistry<ResourceLocation, ResourceType> resourceTypeRegistry) {
        super(type, syncId);
        this.resourceTypeRegistry = resourceTypeRegistry;
        this.player = null;
    }
