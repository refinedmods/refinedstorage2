...
public class FluidGridScreen extends GridScreen<FluidResource, FluidGridScreenHandler> {
    public FluidGridScreen(FluidGridScreenHandler handler, Inventory inventory, Component title) {
    ...
    @Override
    protected void renderResource(PoseStack matrices, int slotX, int slotY, GridResource<FluidResource> resource) {
    ...
    private void renderFluidSprite(PoseStack matrices, int slotX, int slotY, FluidVariant variant, TextureAtlasSprite sprite) {
        ...
        bufferBuilder
                .vertex(matrices.last().pose(), (float) slotX, (float) slotYEnd, (float) z)
                .uv(sprite.getU0(), sprite.getV1())
                .color(r, g, b, 255)
                .endVertex();
        bufferBuilder
                .vertex(matrices.last().pose(), (float) slotXEnd, (float) slotYEnd, (float) z)
                .uv(sprite.getU1(), sprite.getV1())
                .color(r, g, b, 255)
                .endVertex();
        bufferBuilder
                .vertex(matrices.last().pose(), (float) slotXEnd, (float) slotY, (float) z)
                .uv(sprite.getU1(), sprite.getV0())
                .color(r, g, b, 255)
                .endVertex();
        bufferBuilder
                .vertex(matrices.last().pose(), (float) slotX, (float) slotY, (float) z)
