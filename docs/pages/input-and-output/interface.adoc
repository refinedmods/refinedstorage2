...
It provides intermediate storage slots for importing and exporting resources, but does not automatically interact with external inventories.
...
> The {doctitle} does not insert resources into adjacent inventories automatically; you must extract them yourself.
