...
- Support for FE, Source (Ars Nouveau) and Souls (Industrial Foregoing Souls) storages with link:https://www.curseforge.com/minecraft/mc-mods/refined-types[Refined Types]
...
* A shortcut (CTRL/CMD+SHIFT on result slot) to filter the Grid by crafting matrix contents.
