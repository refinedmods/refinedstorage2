...
|===
| *Supports* | Refined Storage v2.0.0 on Minecraft 1.21.1
| *Download* | link:https://www.curseforge.com/minecraft/mc-mods/refined-types[CurseForge]
|===
...
|===
| *Supports* | Refined Storage v2.0.0 on Minecraft 1.21.1
| *Download* | link:https://www.curseforge.com/minecraft/mc-mods/pipe-connector[CurseForge]
|===
