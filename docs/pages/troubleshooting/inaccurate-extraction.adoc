...
If you try to extract some modded items, especially tools or weapons, from the xref:../viewing-resources/grid.adoc[], and you get a warning about an inaccurate extraction, here's what happening:
