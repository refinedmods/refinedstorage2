...
public final class ItemStubs {
    ...
    public static final Rs2Item COBBLESTONE = new ItemStub(4, "Cobblestone", 64);
    public static final Rs2Item SPONGE = new ItemStub(5, "Sponge", 64);
    public static final Rs2Item BUCKET = new ItemStub(6, "Bucket", 16);
    public static final Rs2Item DIAMOND = new ItemStub(7, "Diamond", 64);
