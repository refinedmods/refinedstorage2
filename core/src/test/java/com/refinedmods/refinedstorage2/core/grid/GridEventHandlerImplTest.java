...
class GridEventHandlerImplTest {
    ...
    void Test_inserting_entire_stack_from_cursor() {
        // Arrange
        storageChannel.setSources(Arrays.asList(new ItemDiskStorage(30)));
    ...
    void Test_extracting_item(GridExtractMode mode) {
        // Arrange
        storageChannel.setSources(Arrays.asList(new ItemDiskStorage(35)));
    ...
    void Test_extracting_item_that_has_large_count(GridExtractMode mode) {
        // Arrange
        storageChannel.setSources(Arrays.asList(new ItemDiskStorage(1000)));
    ...
    void Test_extracting_item_should_respect_max_stack_size(GridExtractMode mode) {
        // Arrange
        storageChannel.setSources(Arrays.asList(new ItemDiskStorage(100)));
