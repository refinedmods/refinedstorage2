...
class ThrottleHelperTest {
    ...
    void Test_should_throttle_correctly_with_single_key() {
        ...
        assertThat(throttleHelper.throttle("key 1", () -> {}, 0)).isTrue();
        ...
        assertThat(throttleHelper.throttle("key 1", () -> {}, 500)).isTrue();
    }
    ...
    void Test_should_throttle_correctly_with_multiple_keys() {
        ...
        assertThat(throttleHelper.throttle("key 1", () -> {}, 0)).isTrue();
        assertThat(throttleHelper.throttle("key 2", () -> {}, 100)).isTrue();
        ...
        assertThat(throttleHelper.throttle("key 1", () -> {}, 500)).isTrue();
        assertThat(throttleHelper.throttle("key 2", () -> {}, 600)).isTrue();
    }
}
