...
public enum OrientedDirection implements StringRepresentable {
    ...
    public static OrientedDirection forDirection(final Direction direction) {
    ...
    public static OrientedDirection forHorizontalDirection(final HorizontalDirection horizontalDirection) {
    ...
    public static OrientedDirection forHorizontalDirection(final Direction horizontalDirection) {
        return switch (horizontalDirection) {
            case NORTH -> NORTH;
            case SOUTH -> SOUTH;
            case WEST -> WEST;
    ...
    public static OrientedDirection forUpDirection(final Direction verticalDirection) {
    ...
    public static OrientedDirection forDownDirection(final Direction verticalDirection) {
        return switch (verticalDirection) {
