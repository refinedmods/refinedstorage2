...
class RelayPassEnergySideButtonWidget extends AbstractYesNoSideButtonWidget {
    ...
    private static final Identifier YES = createIdentifier("widget/side_button/relay/pass_energy/yes");
    private static final Identifier NO = createIdentifier("widget/side_button/relay/pass_energy/no");
