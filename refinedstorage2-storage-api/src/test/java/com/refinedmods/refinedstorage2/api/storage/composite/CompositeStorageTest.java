...
class CompositeStorageTest {
    ...
    void Test_setting_sources_should_fill_list() {
        ...
        BulkStorage<String> storage3 = new BulkStorageImpl<>(10);
    ...
    void Test_single_source_insert_without_remainder(Action action) {
        // Arrange
        BulkStorage<String> storage = new BulkStorageImpl<>(20);
    ...
    void Test_multiple_source_insert_without_remainder(Action action) {
        // Arrange
        BulkStorage<String> storage1 = new BulkStorageImpl<>(5);
        BulkStorage<String> storage2 = new BulkStorageImpl<>(10);
        BulkStorage<String> storage3 = new BulkStorageImpl<>(20);
    ...
    void Test_multiple_source_partial_extract(Action action) {
        ...
        BulkStorage<String> storage2 = new BulkStorageImpl<>(5);
    ...
    void Test_prioritizing_when_inserting() {
        // Arrange
        PrioritizedStorage<String> highestPriority = new PrioritizedStorage<>(10, new BulkStorageImpl<>(10));
        PrioritizedStorage<String> lowestPriority = new PrioritizedStorage<>(5, new BulkStorageImpl<>(10));
