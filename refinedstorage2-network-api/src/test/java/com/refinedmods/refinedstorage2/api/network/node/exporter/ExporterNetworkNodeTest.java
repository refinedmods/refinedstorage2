...
class ExporterNetworkNodeTest {
    ...
    @Test
    void shouldSetTemplatesWithoutStrategy() {
        // Arrange
    ...
    @Test
    void shouldTransferWithMultipleResources(@InjectNetworkStorageChannel final StorageChannel<String> storageChannel) {
        // Arrange
        storageChannel.addSource(new InMemoryStorageImpl<>());
    ...
    @Test
    void shouldUseAlternativeResource(@InjectNetworkStorageChannel final StorageChannel<String> storageChannel) {
        // Arrange
        storageChannel.addSource(new InMemoryStorageImpl<>());
        storageChannel.insert("B", 7, Action.EXECUTE, EmptyActor.INSTANCE);
