...
@NetworkTest
@SetupNetwork
class InterfaceExternalStorageProviderTest {
    @AddNetworkNode
    ...
    void shouldExposeExportedResources(
        ...
        externalStorage.initialize(new ExternalStorageProviderFactoryImpl(
            new InterfaceExternalStorageProvider<>(() -> exportState)
        ));
    ...
    void shouldNotExposeExportedResourceWithoutExportState(
        ...
        externalStorage.initialize(new ExternalStorageProviderFactoryImpl(
            new InterfaceExternalStorageProvider<>(() -> null)
        ));
    ...
    @ParameterizedTest
    @EnumSource(Action.class)
    void shouldNotInsertWithoutExportState(
        final Action action,
        @InjectNetworkStorageChannel final StorageChannel<String> networkStorage
    ) {
        // Arrange
