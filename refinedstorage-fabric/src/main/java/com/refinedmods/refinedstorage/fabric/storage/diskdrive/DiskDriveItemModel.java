...
import static com.refinedmods.refinedstorage.fabric.storage.diskdrive.DiskDriveRenderingProperties.DISKS;
...
public class DiskDriveItemModel implements ItemModel {
    ...
    private static Matrix4f getOffsetTransform(final ItemTransform baseTransform) {
        ...
        return new Matrix4f()
            .rotateXYZ(baseTransform.rotation().x() * toRad, baseTransform.rotation().y() * toRad,
